...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function L$1(l, u, i) {
        ...
        if (
            ...
            (t = l.ref) &&
                ((t.current && t.current !== l.__e) || z(t, null, u)),
                    ...
                    try {
                        if (
                            ((i = u.constructor) &&
                                ...
                                (u.setState(i.getDerivedStateFromError(n)),
                                (t = u.__d)),
    ...
    (n.unmount = function (n) {
        ...
        ((L.prototype = new p()).__c = function (n, t) {
            ...
            var l = function () {
                ...
                f = !0 === t.__h;
            r.__u++ || f || r.setState({ __e: (r.__b = r.__v.__k[0]) }),
                n.then(i, i);
        }),
        ...
        (L.prototype.render = function (n, t) {
            ...
            return (
                u && (u.__h = null),
                [a$1(y, null, t.__e ? null : n.children), u]
            );
        });
    var M = function (n, t, e) {
        if (
            ...
            n.props.revealOrder &&
                ("t" !== n.props.revealOrder[0] || !n.o.size))
        )
            for (e = n.u; e; ) {
    ...
    var DAY_IDS = ["الأحد", "الإثنين", "الثلاثاء", "الأربعاء", "الخميس", "الجمعة", "السبت"];
    // Adding
    ...
    */
    ...
    function isArraysEqual(a0, a1, equalityFunc) {
        ...
        for (i = 0; i < len; i += 1) {
            if (
                !(equalityFunc ? equalityFunc(a0[i], a1[i]) : a0[i] === a1[i])
            ) {
                return false;
            }
        }
        ...
        return function (newArgHash) {
            ...
            for (var key in newArgHash) {
                if (!currentResHash[key]) {
                    ...
                    !isArraysEqual(currentArgHash[key], newArgHash[key])
                ) {
                    if (teardownFunc) {
    ...
    function createVerboseFormattingArg(
        ...
        return {
            ...
            defaultSeparator:
                betterDefaultSeparator || context.defaultSeparator,
        };
    }
    ...
    */
    ...
    var CalendarApi = /** @class */ (function () {
        ...
        CalendarApi.prototype.on = function (handlerName, handler) {
            ...
            if (
                currentDataManager.currentCalendarOptionsRefiners[handlerName]
            ) {
        ...
        CalendarApi.prototype.getEventSources = function () {
            ...
            for (var internalId in sourceHash) {
                sourceApis.push(
                    new EventSourceApi(state, sourceHash[internalId])
                );
            }
            return sourceApis;
        };
        ...
        */
        ...
        Object.defineProperty(EventApi.prototype, "startStr", {
            get: function () {
                var instance = this._instance;
                if (instance) {
                    return this._context.dateEnv.formatIso(
                        instance.range.start,
                        {
    ...
    var RAW_EN_LOCALE = __assign(__assign({}, MINIMAL_RAW_EN_LOCALE), {
        ...
        moreLinkHint: function (eventCnt) {
            return (
                "Show " + eventCnt + " more event" + (eventCnt === 1 ? "" : "s")
            );
        },
    });
    ...
    */
    ...
    function getDateMeta(date, todayRange, nowDate, dateProfile) {
        return {
            ...
            isToday: Boolean(
                todayRange && rangeContainsMarker(todayRange, date)
            ),
            isPast: Boolean(
                nowDate
                    ? date < nowDate
    ...
    var Theme = /** @class */ (function () {
        ...
        Theme.prototype.getIconClass = function (buttonName, isRtl) {
            ...
            if (isRtl && this.rtlIconClasses) {
                className =
                    this.rtlIconClasses[buttonName] ||
                    this.iconClasses[buttonName];
            } else {
    ...
    */
    ...
    var ContentHookInner = /** @class */ (function (_super) {
        ...
        ContentHookInner.prototype.getContentMeta = function (innerContent) {
            var contentTypeHandlers =
                this.context.pluginHooks.contentTypeHandlers;
            var contentKey = "";
    ...
    var MountHook = /** @class */ (function (_super) {
        ...
        MountHook.prototype.componentDidMount = function () {
            ...
            if (callback) {
                callback(
                    __assign(__assign({}, this.props.hookProps), {
                        el: this.rootEl,
                    })
                );
            }
                    ...
                    return createElement(
                        ...
                        function (viewElRef, viewClassNames) {
                            var hookProps = __assign(__assign({}, viewProps), {
                                nextDayThreshold:
                                    context.options.nextDayThreshold,
                            });
                            return createElement(
                                RenderHook,
                                {
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        DateProfileGenerator.prototype.buildCurrentRangeInfo = function (
            ...
            if (props.duration) {
                ...
                unit = props.dateEnv.greatestWholeUnit(
                    range.start,
                    range.end
                ).unit;
            } else {
            ...
            if (!dateAlignment) {
                ...
                if (dateIncrement) {
                    ...
                    if (asRoughMs(dateIncrement) < asRoughMs(duration)) {
                        dateAlignment =
                            greatestDurationDenominator(dateIncrement).unit;
                    } else {
                        dateAlignment = unit;
                    }
                } else {
        ...
        switch (action.type) {
            case "SET_OPTION":
                return __assign(
                    ...
                    ((_a = {}),
                    (_a[action.optionName] = action.rawOptionValue),
                    _a)
                );
            default:
    ...
    function reduceDateProfile(
        ...
        switch (action.type) {
            case "CHANGE_VIEW_TYPE":
                return dateProfileGenerator.build(
                    action.dateMarker || currentDate
                );
            case "CHANGE_DATE":
                return dateProfileGenerator.build(action.dateMarker);
            case "PREV":
                dp = dateProfileGenerator.buildPrev(
                    currentDateProfile,
                    currentDate
                );
                if (dp.isValid) {
                ...
                break;
            case "NEXT":
                dp = dateProfileGenerator.buildNext(
                    currentDateProfile,
                    currentDate
                );
                if (dp.isValid) {
    ...
    */
    function parseSection(
        ...
        var calendarButtonHintOverrides =
        ...
        var widgets = sectionSubstrs.map(function (buttonGroupStr) {
            return buttonGroupStr.split(",").map(function (buttonName) {
                ...
                if ((customButtonProps = calendarCustomButtons[buttonName])) {
                    buttonClick = function (ev) {
                        if (customButtonProps.click) {
                            customButtonProps.click.call(
                                ...
                                ev,
                                ev.target
                            ); // TODO: use Calendar this context?
                        }
                    };
                    (buttonIcon =
                    ...
                    buttonHint =
                        customButtonProps.hint || customButtonProps.text;
    ...
    var eventSourceDef$1 = {
        ...
        fetch: function (arg, success, failure) {
            ...
            var requestParams = buildRequestParams$1(
                meta,
                arg.range,
                arg.context
            );
    ...
    var recurring = {
        parse: function (refined, dateEnv) {
            if (
                ...
                return {
                    allDayGuess: Boolean(
                        !refined.startTime && !refined.endTime
                    ),
                    duration: duration,
    ...
    */
    ...
    function buildDomNodeRenderer() {
        ...
        function render(el, domNodes) {
            ...
            if (
                el !== currentEl ||
                !isArraysEqual(currentDomNodes, newDomNodes)
            ) {
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype._handleAction = function (action) {
            ...
            var newState = {
                ...
                eventSelection: reduceSelectedEvent(
        ...
        CalendarDataManager.prototype.updateData = function () {
            ...
            if (
                ...
                if (
                    oldCalendarOptions.timeZone !== newCalendarOptions.timeZone
                ) {
                    // hack
            ...
            for (var optionName in raw) {
                if (optionName !== "plugins") {
                    ...
                    if (
                        ...
                        refined[optionName] = refiners[optionName](
                            raw[optionName]
                        );
                        anyChanges = true;
                    } else {
    ...
    var SegHierarchy = /** @class */ (function () {
        ...
        SegHierarchy.prototype.isInsertionValid = function (insertion, entry) {
            return (
                ...
                (this.maxStackCnt === -1 ||
                    insertion.stackCnt < this.maxStackCnt)
            );
        };
        ...
        SegHierarchy.prototype.insertEntryAt = function (entry, insertion) {
            ...
            if (insertion.lateral === -1) {
                ...
                insertAt(
                    entriesByLevel[insertion.level],
                    insertion.lateral,
                    entry
                );
            }
        ...
        SegHierarchy.prototype.findInsertion = function (newEntry) {
            ...
            for (
                ...
                while (
                    ...
                    var trackingEntryBottom =
                        trackingCoord + trackingEntry.thickness;
    ...
    var CalendarContent = /** @class */ (function (_super) {
        ...
        function CalendarContent() {
            ...
            _this.registerInteractiveComponent = function (
                ...
                var settings = parseInteractionSettings(
                    component,
                    settingsInput
                );
    ...
    */
    ...
    var SimpleScrollGrid = /** @class */ (function (_super) {
        ...
        function SimpleScrollGrid() {
            ...
            _this.scrollerElRefs = new RefMap(
                _this._handleScrollerEl.bind(_this)
            );
            _this.state = {
                shrinkWidth: null,
    ...
    var EventRoot = /** @class */ (function (_super) {
        ...
        EventRoot.prototype.render = function () {
            ...
            var hookProps = {
                ...
                isEndResizable:
                    !props.disableResizing && computeSegEndResizable(seg),
                isMirror: Boolean(
                    props.isDragging ||
                        props.isResizing ||
                        props.isDateSelecting
                ),
        ...
        StandardEvent.prototype.render = function () {
            ...
            return createElement(
                EventRoot,
                {
                    ...
                    defaultContent:
                        props.defaultContent || renderInnerContent$4,
        ...
        MoreLinkRoot.prototype.render = function () {
            ...
            return createElement(
                ...
                function (context) {
                    ...
                    var title = formatWithOrdinals(
                        options.moreLinkHint,
                        [moreCnt],
                        text
                    );
                    var hookProps = {
    ...
    var Calendar = /** @class */ (function (_super) {
        ...
        Calendar.prototype.setClassNames = function (classNames) {
            if (!isArraysEqual(classNames, this.currentClassNames)) {
                ...
                for (
                    var _i = 0, _a = this.currentClassNames;
                    _i < _a.length;
                    _i++
                ) {
                    var className = _a[_i];
    ...
    var ElementScrollGeomCache = /** @class */ (function (_super) {
        ...
        function ElementScrollGeomCache(el, doesListening) {
            return (
                _super.call(
                    this,
                    new ElementScrollController(el),
                    doesListening
                ) || this
            );
        }
        ...
        HitDragging.prototype.processFirstCoord = function (ev) {
            ...
            if (initialHit) {
                if (this.useSubjectCenter && subjectRect) {
                    var slicedSubjectRect = intersectRects(
                        subjectRect,
                        initialHit.rect
                    );
        ...
        function DateClicking(settings) {
            ...
            _this.handlePointerDown = function (pev) {
                ...
                dragging.setIgnoreMove(
                    !_this.component.isValidDateDownEl(downEl)
                );
            };
                    ...
                    if (
                        ...
                        var arg = __assign(
                            ...
                            ),
                            {
                                ...
                                view:
                                    context.viewApi || context.calendarApi.view,
                            }
                        );
    ...
    */
            ...
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                if (!isFinal) {
                    ...
                    _this.dragging.setMirrorIsVisible(
                        !hit ||
                            !getElRoot(_this.subjectEl).querySelector(
                                ".fc-event-mirror"
                            )
                    );
                    ...
                    if (validMutation) {
                        ...
                        if (receivingContext_1 === initialContext_1) {
                            ...
                            for (
                                var _i = 0,
                                    _b =
                                        initialContext_1.getCurrentData()
    ...
    var EventResizing = /** @class */ (function (_super) {
        ...
        function EventResizing(settings) {
            ...
            dragging.touchScrollAllowed = false;
            dragging.autoScroller.isEnabled =
                component.context.options.dragScroll;
            var hitDragging = (_this.hitDragging = new HitDragging(
                _this.dragging,
                interactionSettingsToStore(settings)
            ));
    ...
    function computeMutation(hit0, hit1, isFromStart, instanceRange) {
        ...
        if (isFromStart) {
            ...
            dateEnv.add(instanceRange.end, delta) > instanceRange.start
        ) {
    ...
    var UnselectAuto = /** @class */ (function () {
        function UnselectAuto(context) {
            ...
            this.onDocumentPointerDown = function (pev) {
                ...
                _this.matchesEvent = !!elementClosest(
                    downEl,
            ...
            this.onDocumentPointerUp = function (pev) {
                ...
                if (!documentPointer.wasTouchScroll) {
                    if (
                        ...
                        if (
                            unselectAuto &&
                            (!unselectAuto || !_this.matchesCancel)
                        ) {
    ...
    */
                    ...
                    return createElement(
                        ...
                        createElement(ScrollGrid, {
                            ...
                            colGroups: [
                                {
                                    cols: [
                                        { span: colCnt, minWidth: dayMinWidth },
                                    ],
                                },
                            ],
                            sections: sections,
    ...
    var TableListItemEvent = /** @class */ (function (_super) {
        ...
        TableListItemEvent.prototype.render = function () {
            var _a = this,
                ...
                context = _a.context;
            var timeFormat =
                context.options.eventTimeFormat ||
                DEFAULT_TABLE_EVENT_TIME_FORMAT;
            var timeText = buildSegTimeText(
                props.seg,
                timeFormat,
                context,
    ...
    function renderInnerContent$2(innerProps) {
        return createElement(
            ...
            createElement("div", {
                ...
                style: {
                    borderColor:
                        innerProps.borderColor || innerProps.backgroundColor,
                },
            }),
            innerProps.timeText &&
                createElement(
            ...
            if (this.hiddenConsumes && touchingEntry) {
                ...
                if (!forceHidden[touchingEntryId]) {
                    if (this.allowReslicing) {
                        var placeholderEntry = __assign(
                            __assign({}, touchingEntry),
                            {
                                span: intersectSpans(
                                    touchingEntry.span,
                                    entry.span
    ...
    var TableRow = /** @class */ (function (_super) {
        ...
        TableRow.prototype.render = function () {
            ...
            var bgEventSegsByCol = splitSegsByFirstCol(
                props.bgEventSegs,
                colCnt
            );
            ...
            var mirrorSegsByCol = splitSegsByFirstCol(
                this.getMirrorSegs(),
                colCnt
            );
            ...
            return createElement(
                ...
                props.cells.map(function (cell, col) {
                    var normalFgNodes = _this.renderFgSegs(
                        col,
                        props.forPrint
                            ? singleColPlacements[col]
                            : multiColPlacements[col],
                        props.todayRange,
                        isForcedInvisible
                    );
                    var mirrorFgNodes = _this.renderFgSegs(
                        col,
                        buildMirrorPlacements(
                            mirrorSegsByCol[col],
                            multiColPlacements
                        ),
                        props.todayRange,
                    ...
                    return createElement(TableCell, {
                        ...
                        bgContent: createElement(
                            Fragment,
                            null,
                            _this.renderFillSegs(
                                highlightSegsByCol[col],
                                "highlight"
                            ),
                            _this.renderFillSegs(
                                businessHoursByCol[col],
                                "non-business"
                            ),
                            _this.renderFillSegs(
                                bgEventSegsByCol[col],
                                "bg-event"
                            )
                        ),
                    });
        ...
        TableRow.prototype.componentDidUpdate = function (
            prevProps,
            prevState
        ) {
        ...
        TableRow.prototype.renderFgSegs = function (
            ...
            if (framePositions) {
                for (
                    ...
                    var isVisible =
                        placement.isVisible && !isForcedInvisible[instanceId];
                    ...
                    nodes.push(
                        createElement(
                            "div",
                            {
                                ...
                                ref: isMirror
                                    ? null
                                    : this.segHarnessRefs.createRef(key),
                                style: {
        ...
        TableRow.prototype.updateSizing = function (isExternalSizingChange) {
            ...
            if (
                ...
                var limitByContentHeight =
                    props.dayMaxEvents === true ||
                    props.dayMaxEventRows === true;
                this.safeSetState({
        ...
        TableRow.prototype.queryEventInstanceHeights = function () {
            ...
            for (var key in segElMap) {
                var height = Math.round(
                    segElMap[key].getBoundingClientRect().height
                );
    ...
    var Table = /** @class */ (function (_super) {
        ...
        Table.prototype.render = function () {
            ...
            var bgEventSegsByRow = this.splitBgEventSegs(
                props.bgEventSegs,
                rowCnt
            );
            var fgEventSegsByRow = this.splitFgEventSegs(
                props.fgEventSegs,
                rowCnt
            );
            ...
            var eventResizeByRow = this.splitEventResize(
                props.eventResize,
                rowCnt
            );
            var limitViaBalanced =
                dayMaxEvents === true || dayMaxEventRows === true;
                                ...
                                createElement(
                                    ...
                                    props.cells.map(function (cells, row) {
                                        return createElement(TableRow, {
                                            ...
                                            businessHourSegs:
                                                businessHourSegsByRow[row],
                                            eventSelection:
                                                props.eventSelection,
                                            bgEventSegs:
                                                bgEventSegsByRow[row].filter(
                                                    isSegAllDay
                                                ) /* hack */,
                                            fgEventSegs: fgEventSegsByRow[row],
                                            dateSelectionSegs:
                                                dateSelectionSegsByRow[row],
    ...
    */
    ...
    function findNextLevelSegs(hierarchy, subjectLevel, subjectLateral) {
        ...
        for (
            ;
            level < levelCnt && levelCoords[level] < afterSubject;
            level += 1
        ); // do nothing
        ...
        TimeCol.prototype.renderPositionedFgSegs = function (
            ...
            return createElement(
                ...
                segPlacements.map(function (segPlacement) {
                    ...
                    var isShort =
                        Boolean(rect) &&
                        rect.span.end - rect.span.start < eventShortHeight; // look at other places for this problem
                    return createElement(
                        "div",
                        {
                            className:
        ...
        TimeCol.prototype.renderHiddenGroups = function (hiddenGroups, segs) {
            ...
            return createElement(
                ...
                hiddenGroups.map(function (hiddenGroup) {
                    ...
                    var hiddenSegs = compileSegsFromEntries(
                        hiddenGroup.entries,
                        segs
                    );
                    return createElement(TimeColMoreLink, {
                        key: buildIsoString(
                            computeEarliestSegStart(hiddenSegs)
                        ),
            ...
            sortedFgSegs.map(function (seg) {
                ...
                return createElement(
                    "div",
                    {
                        key: instanceId,
                        style: {
                            visibility: hiddenInstances[instanceId]
                                ? "hidden"
                                : "",
                        },
                    },
    ...
    */
                    ...
                    return createElement(
                        ...
                        createElement(
                            Scroller,
                            {
                                ...
                                overflowX: props.isHeightAuto
                                    ? "visible"
                                    : "hidden",
                                overflowY: props.isHeightAuto
                                    ? "visible"
                                    : "auto",
                            },
                            eventSegs.length > 0
            ...
            return createElement(
                ...
                function (nowDate, todayRange) {
                    ...
                    return createElement(
                        ...
                        {
                            className:
                                "fc-list-table " + theme.getClass("table"),
                        },
                        createElement(
                            "thead",
                            null,
    ...
    var eventSourceDef = {
        ...
        fetch: function (arg, onSuccess, onFailure) {
            ...
            var meta = arg.eventSource.meta;
            var apiKey =
                meta.googleCalendarApiKey || options.googleCalendarApiKey;
            if (!apiKey) {
                onFailure({
                    message:
